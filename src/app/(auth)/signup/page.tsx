...
export default function SignupPage() {
  ...
  const handleSignup = async (formData: any) => {
    ...
    const { email, password, confirmPassword, firstName, lastName, selectedCurricula } = formData;
    ...
    try {
      ...
      await setDoc(doc(firestore, "users", user.uid), {
        ...
        bio: '',
        curricula: role === 'teacher' ? selectedCurricula : [],
      });
  ...
  const SignupForm = ({ role, onSignup, onBack }: { role: Role, onSignup: (data: any) => void, onBack: () => void }) => {
    ...
    const onSubmit = (e: React.FormEvent) => {
        ...
        onSignup({ email, password, confirmPassword, firstName, lastName, selectedCurricula });
    };
    ...
    return (
        ...
        <CardContent>
            ...
            <Button type="submit" className="w-full" disabled={passwordStrength < 100}>
                Create an account
            </Button>
